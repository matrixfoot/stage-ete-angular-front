...
@Component({
  selector: 'app-tous-utilisateurs',
  templateUrl: './tous-utilisateurs.component.html',
  styleUrls: ['./tous-utilisateurs.component.scss']
})
export class TousUtilisateursComponent implements OnInit {
  utilisateurs = [
    {
