...
@Component({
  selector: 'app-facture-reglees',
  templateUrl: './facture-reglees.component.html',
  styleUrls: ['./facture-reglees.component.scss']
})
export class FactureRegleesComponent implements OnInit {
  factures = [
    {
      code: 'F001',
      nom: 'Omar KAMMOUN',
