...
@Component({
  selector: 'app-candidatures-en-cours-execution',
  templateUrl: './candidatures-en-cours-execution.component.html',
  styleUrls: ['./candidatures-en-cours-execution.component.scss']
})
export class CandidaturesEnCoursExecutionComponent implements OnInit {
  candidatures = [
    {
