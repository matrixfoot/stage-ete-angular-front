...
@Component({
  selector: 'app-anx5p1',
  templateUrl: './anx5p1.component.html',
  styleUrls: ['./anx5p1.component.scss']
})
export class Anx5p1Component  implements OnInit {
  ...
  ngOnInit() {
    this.anxdebForm = this.fb.group({
      E500: [{ value: 'E5', disabled: true }, [Validators.required, this.validateE500]],
      ...
      E505: ['', Validators.pattern('^[a-zA-Z0-9]{4}$')],
      E506: [{ value: 'An5', disabled: true }, [Validators.required, this.validateE506]],
      E507: ['', [Validators.required, Validators.pattern('^[012]{1}$')]],
      E508: ['', Validators.pattern('^[0-9]{6}$')],
      E509: ['', Validators.pattern('^[a-zA-Z0-9]{40}$')],
      E510: ['', Validators.pattern('^[a-zA-Z0-9]{40}$')],
      E511: ['', Validators.pattern('^[a-zA-Z0-9]{40}$')],
      E512: ['', Validators.pattern('^[a-zA-Z0-9]{72}$')],
      E513: ['', Validators.pattern('^[0-9]{4}$')],
      E514: ['', Validators.pattern('^[0-9]{4}$')],
      E515: ['', Validators.pattern('^[a-zA-Z0-9]{171}$')],
    });
  ...
  validateE500(control: FormControl) {
    return control.value === 'E5' ? null : { invalidValue: true };
  } 
  ...
  validateE506(control: FormControl) {
    return control.value === 'An5' ? null : { invalidValue: true };
  }

  toggleFormControls(enable: boolean) {
    if (enable) {
      this.anxdebForm.enable();
      this.anxdebForm.controls['E500'].disable();
      this.anxdebForm.controls['E004'].disable();
      this.anxdebForm.controls['E506'].disable();
    } else {
