...
@Component({
  selector: 'app-utilisateurs-actifs',
  templateUrl: './utilisateurs-actifs.component.html',
  styleUrls: ['./utilisateurs-actifs.component.scss']
})
export class UtilisateursActifsComponent implements OnInit {
  utilisateurs = [
    {
